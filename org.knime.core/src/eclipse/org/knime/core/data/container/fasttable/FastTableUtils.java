...
public final class FastTableUtils {

    private FastTableUtils() {
    }

    /**
     * @param spec
     * @return null, if no spec can be derived.
     */
    public static ColumnType<?, ?>[] deriveSpec(final DataTableSpec spec, final boolean rowKey) {
    ...
    public static ColumnType<?, ?> map(final DataColumnSpec columnSpec) {
